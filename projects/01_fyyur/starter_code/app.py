...
def create_venue_submission():
  ...
  for genre in genres:
    ...
    if genre_object:
      ...
      venue_object.genres.append(Genre(name=genre))
  try:
...
def edit_artist(artist_id):
  form = ArtistForm()
  artist_object = Artist.query.filter_by(id=artist_id).first()
...
def edit_venue(venue_id):
  form = VenueForm()
  venue_object = Venue.query.filter_by(id=venue_id).first()
...
def create_artist_submission():
  ...
  for genre in genres:
    ...
    if genre_object:
      ...
      artist_object.genres.append(Genre(name=genre))
  try:
